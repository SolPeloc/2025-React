...
const Contador = () => {
  ...
  return (
      <div>
        <button onClick={()=> setContador(contador+1)} style={{color:"white"}}>+</button> {/* aca, cada vez que haga click en boton, la funcion setcontador, va ejecutar la funcion anonima que le puse, que a la variable contador le sume 1 */}                                                                                                                                                          
