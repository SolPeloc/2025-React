...
export const CarritoProvider = ({ children }) => {
  ///proveedor, recibe children, que son los componentes que envolverá para compartirles el estado del carrito.
      ...
      return existe
        ? prevCarrito.map((item) =>
            item.id === producto.id
              ...
              : item
          ) // si existe, le sumo 1 a la cantidad, sino devuelvo el item sin cambios.
  ...
  const finalizarCompra = () => {
    toast(<SplitButtons />, {
      closeButton: false,
      className: "p-4 w-[400px] border border-purple-600/40",
      hideProgressBar: true,
      autoClose: 2000,
      ariaLabel: "Confirmación de compra",
    });
  ...
  useEffect(() => {
    const carritoSuma = carrito.reduce(
